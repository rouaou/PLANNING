...
export class MainComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getStaffCount();
    this.getStaffGrpCount();

  }
  getAppointmentCount() {
    this.appointmentService.getAppointmentCount()
      .subscribe(count => this.appointmentCount = count);
  }
  getPatientCount() {
    this.patientService.getPatientCount()
      .subscribe(count => this.patientCount = count);
  }
  getStaffCount() {
    this.staffService.getStaffCount()
      .subscribe(count => this.staffCount = count);
  }
  getStaffGrpCount() {
    this.staffGroupService.getStaffGrpCount()
      .subscribe(count => this.staffGrpCount = count);
  }
  private smallChart1() {
