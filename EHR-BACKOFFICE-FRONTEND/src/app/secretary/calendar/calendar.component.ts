 ...
 // subs: any;
  ...
  getAppointments(){
    this.appointmentService.retrieveAppointment().subscribe((data)=>{
      this.appointments = data.filter(appointment => appointment.status === 1 );
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 'submit') {
        ...
        this.calendarEvents = this.calendarEvents?.concat({
          ...
          equipment: this.calendarData.equipment,
  ...
  eventClick(row: EventClickArg) {
    const calendarData = {
     ...
     equipment: row.event.extendedProps['equipment'],
  ...
  editEvent(eventIndex: number, calendarData: Calendar) {
   ...
   singleEvent['equipment']= calendarData.equipment;
    ...
    this.addCusForm.setValue({
      ...
      patient: calendarData.patient,
      categoryAppoint: calendarData.categoryAppoint,
      // service: calendarData.service,
      equipment: calendarData.equipment,
    });
