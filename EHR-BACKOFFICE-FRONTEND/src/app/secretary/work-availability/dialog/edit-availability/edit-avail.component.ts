...
@Component({
  selector: 'app-edit-avail',
  templateUrl: './edit-avail.component.html',
  styleUrls: ['./edit-avail.component.scss']
})
export class EditAvailComponent implements OnInit {

  StaffForm: FormGroup;
  staffs: Staff;
  staff: Staff | undefined ;
  constructor(
    public dialogRef: MatDialogRef<EditAvailComponent>,
